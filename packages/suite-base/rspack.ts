...
import type { BuildArgv } from "./BuildArgv";
...
// Create the shared Rspack configuration used by browser targets.
export function makeRspackConfig(
  ...
  return {
          ...
          use: [
            {
              ...
              options: {
                ...
                getCustomTransformers: (program: ts.Program) => ({
                  before: [
                    // only include the refresh transformer when using the dev server
    ...
    // Rspack uses SWC and Lightning CSS minimizers by default.
